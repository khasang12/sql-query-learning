    ...
    <div className="space-y-8">
      ...
      <div className="glass-panel p-8">
        ...
        {queryError && (
          <div className="mt-4 p-4 bg-red-900/20 border border-red-700/50 rounded-lg">
            ...
            <div className="font-mono text-sm text-foreground-secondary">{queryError}</div>
          </div>
        )}
      </div>
          ...
          {filteredQueries.map((sample, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="font-bold text-foreground-primary">{sample.name}</div>
      ...
      <div className="glass-panel p-8">
        ...
        {results.length === 0 ? (
          ...
          const isQueryPlan = columns.length === 1 && columns[0] === 'QUERY PLAN';
          if (isQueryPlan) {
            return (
